...
export class DummyProductService extends ProductService {
  ...
  private dummyData: Product[] = [
    ...
    { id: "1c4a8bce-5c38-4e61-8a75-cb23c3f8b69a", name: "Vaara Pin Set", description: "A set of 4 pins featuring Vaara in different expressions and poses.", price: 19.99, category: "Pin Sets" },
    { id: "1c4a8bce-5c38-4e61-8a75-cb23c3f8b69b", name: "Heroic Trio Pin Set", description: "A collection of pins featuring the main heroes of  the warrior, mage, and rogue.", price: 19.99, category: "Pin Sets" },
    { id: "1c4a8bce-5c38-4e61-8a75-cb23c3f8b69c", name: "Creatures of the Wasteland Pin Set", description: "A set of pins showcasing the unique creatures from the Lunatic universe.", price: 19.99, category: "Pin Sets" },
    { id: "2c4a8bce-5c38-4e61-8a75-cb23c3f8b69d", name: "Felix the Tyrant Pin Set", description: "A set of 4 pins featuring Felix in various poses representing his tyrannical nature.", price: 19.99, category: "Pin Sets" },
    { id: "2c4a8bce-5c38-4e61-8a75-cb23c3f8b69e", name: "The Matriarch Pin Set", description: "A beautiful pin set featuring the Queen of Flowers in elegant designs.", price: 19.99, category: "Pin Sets" },
    { id: "2c4a8bce-5c38-4e61-8a75-cb23c3f8b69f", name: "Zeya and Allies Pin Set", description: "A set of pins featuring Zeya and her allies, showcasing their strength and unity.", price: 19.99, category: "Pin Sets" },
    { id: "1d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f29", name: "Vaara Sticker Set", description: "A set of 10 stickers featuring Vaara in various poses and expressions.", price: 9.99, category: "Stickers" },
    { id: "1d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f30", name: "Heroes of the Wasteland Sticker Set", description: "A collection of stickers featuring the main heroes from Lunatic.", price: 9.99, category: "Stickers" },
    { id: "1d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f31", name: "Magical Creatures Sticker Set", description: "A whimsical sticker set showcasing the magical creatures of Lunatic.", price: 9.99, category: "Stickers" },
    { id: "2d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f32", name: "Felix the Tyrant Sticker Set", description: "A set of 10 stickers featuring Felix in his various forms of tyranny.", price: 9.99, category: "Stickers" },
    { id: "2d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f33", name: "Queen of Flowers Sticker Set", description: "A collection of stickers depicting the Queen of Flowers in beautiful designs.", price: 9.99, category: "Stickers" },
    { id: "2d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f34", name: "Allies of Zeya Sticker Set", description: "A set of stickers featuring Zeya and her loyal allies.", price: 9.99, category: "Stickers" },
    { id: "3d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f35", name: "Epic Battles Sticker Set", description: "A dynamic sticker set showcasing epic battle scenes from Lunatic.", price: 9.99, category: "Stickers" },
    { id: "3d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f36", name: "Symbols of Magic Sticker Set", description: "A mystical sticker set featuring various symbols of magic from Lunatic.", price: 9.99, category: "Stickers" },
    { id: "3d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f37", name: "Tyranny and Rebellion Sticker Set", description: "A thought-provoking sticker set depicting the themes of tyranny and rebellion.", price: 9.99, category: "Stickers" },
    { id: "4d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f38", name: "Stories of the Fallen Sticker Set", description: "A reflective sticker set featuring key moments of fallen heroes in Throne.", price: 9.99, category: "Stickers" },
    { id: "4d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f39", name: "Corruption and Redemption Sticker Set", description: "A powerful sticker set illustrating the themes of corruption and redemption in Lunatic.", price: 9.99, category: "Stickers" },
    { id: "5d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f40", name: "Guardians of the Realm Sticker Set", description: "A set of stickers showcasing the guardians protecting the Throne kingdom.", price: 9.99, category: "Stickers" },
    { id: "5d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f41", name: "Iconic Locations Sticker Set", description: "A sticker set highlighting iconic locations from the Lunatic world.", price: 9.99, category: "Stickers" },
    { id: "5d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f42", name: "Legends of the North Sticker Set", description: "A collection of stickers depicting legendary figures from the Throne North.", price: 9.99, category: "Stickers" },
    { id: "6d5a9cfe-6a92-4c3e-b5eb-e3be8d2a3f43", name: "Emblems of Hope Sticker Set", description: "A motivational sticker set featuring emblems of hope from Lunatic.", price: 9.99, category: "Stickers" },
    //Plushies
    ...
    { id: "1e6b8bce-6f98-42c9-9183-e0f3e6e7b59a", name: "Heroic Trio Plushies", description: "A set of plushies featuring the three main heroes from Lunatic.", price: 69.99, category: "Plushies" },
    ...
    { id: "3f8c8bce-7c3d-4d1a-8d37-b3e28f5e7c40", name: "Vaara Action Figure", description: "An intricately designed action figure of Vaara, showcasing her dark powers.", price: 39.99, category: "Figures" },
    { id: "3f8c8bce-7c3d-4d1a-8d37-b3e28f5e7c41", name: "Felix the Tyrant Figure", description: "A detailed figure of Felix, the tyrannical overlord, complete with his throne.", price: 39.99, category: "Figures" },
    //Bags
    { id: "4g1c8bce-8e4e-4a12-9b1e-d4e24e4c9e72", name: "Vaara Tote Bag", description: "A stylish tote bag featuring artwork of Vaara from Lunatic, perfect for everyday use.", price: 29.99, category: "Bags" },
    { id: "4g1c8bce-8e4e-4a12-9b1e-d4e24e4c9e73", name: "Kingdom Crest Backpack", description: "A durable backpack adorned with the crest of the Throne kingdom, suitable for school or travel.", price: 49.99, category: "Bags" },
    //KeyChains
    { id: "5h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b81", name: "Vaara Key Chain", description: "A stylish key chain featuring a detailed charm of Vaara.", price: 9.99, category: "KeyChains" },
    { id: "5h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b82", name: "Heroic Trio Key Chain Set", description: "A set of key chains featuring the three main heroes.", price: 24.99, category: "KeyChains" },
    { id: "5h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b83", name: "Magical Creature Key Chain", description: "A cute key chain showcasing one of the magical creatures.", price: 9.99, category: "KeyChains" },
    { id: "6h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b84", name: "Felix the Tyrant Key Chain", description: "An intricate key chain featuring Felix in his regal form.", price: 9.99, category: "KeyChains" },
    { id: "6h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b85", name: "Queen of Flowers Key Chain", description: "A beautiful key chain depicting the Queen of Flowers.", price: 9.99, category: "KeyChains" },
    { id: "6h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b86", name: "Zeya Key Chain", description: "A stylish key chain featuring Zeya, ready for battle.", price: 9.99, category: "KeyChains" },
    { id: "7h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b87", name: "Epic Battles Key Chain Set", description: "A set of key chains showcasing epic battle scenes.", price: 24.99, category: "KeyChains" },
    { id: "7h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b88", name: "Symbols of Magic Key Chain", description: "A key chain featuring various symbols of magic.", price: 9.99, category: "KeyChains" },
    { id: "7h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b89", name: "Guardians Key Chain Set", description: "A collection of key chains featuring the guardians.", price: 24.99, category: "KeyChains" },
    { id: "8h2d9cfe-9f4f-4f82-ae35-e2d55f1b3b90", name: "Emblems of Hope Key Chain", description: "A motivational key chain featuring emblems of hope.", price: 9.99, category: "KeyChains" },
    //Stand
    { id: "9i3b8cfe-5e7a-4c9f-bc3d-d8d69e9e0f12", name: "Display Stand for Collectibles", description: "A sturdy display stand designed to showcase your favorite collectibles from Lunatic and Throne.", price: 34.99, category: "Stand" },
    //Lanyard
    ...
    { id: "c1d2e3f4-60c2-48b9-8a50-123456789041", name: "Lunatic Warrior Cap", description: "A stylish cap featuring the emblem of Lunatic's warriors.", price: 24.99, category: "Hats" },
    { id: "c1d2e3f4-60c2-48b9-8a50-123456789042", name: "Throne Champion Hat", description: "A hat representing the champions of Throne.", price: 24.99, category: "Hats" },
    ...
    { id: "c1d2e3f4-60c2-48b9-8a50-123456789046", name: "Throne's Frozen Beanie", description: "A warm beanie featuring icy designs from Throne.", price: 19.99, category: "Hats" },
